    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-y-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            {/* ------ Doctor Information : Name, Degree, Experience, About ------ */}
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <div className="flex gap-3 items-center w-full overflow-x-scroll mt-4">
            ...
            {/* This will solve the problem by not showing the current day/datetime */}
            {docSlots.length &&
              docSlots.map(
                (item, index) =>
